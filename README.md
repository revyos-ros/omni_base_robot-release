## omni_base_robot (humble) - 2.5.2-1

The packages in the `omni_base_robot` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble omni_base_robot --override-release-repository-push-url git@github.com:revyos-ros/omni_base_robot-release.git` on `Sun, 15 Dec 2024 06:06:54 -0000`
